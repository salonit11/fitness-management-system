...
?>
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">MANAGE FEEDBACK</h3>
					 <div class="xs tabls">
						...
						<div class="table-responsive">
                            ...
                            <tr>
								...
								<td><a href="?del=<?php echo $result1['f_id'];?>" onclick="return confirm(' Sure to Delete');" class="btn btn-danger btn-circle btn"><i class="fa fa-trash"></i></a></td>
                            </tr>
                            <?php
								$seq++;
								}
