            ...
            <div class="container">
                ...
                <div class="banner-info text-left">
                    ...
                    <div class="read-more-button">
                        <a href="about2.php" class="read-more scroll btn">Read More </a> </div>
                </div>
            </div>
            <!-- //banner -->
        </div>
        ...
        <div class="container py-md-5">
            <div class="row banner-grids mb-lg-5">
                <div class="col-lg-7 content-right">
                    <h3 class="title-w3pvt">About Fit Factory</h3>
                ...
                <div class="col-lg-3 ab-content">
                    <div class="ab-content-inner">
                        ...
                        <div class="ab-info-con">
                            ...
                            <a href="workout_cat.php?id=<?php echo $cat_id; ?>.php" class="read-more two btn m-0 px-3"><span class="fa fa-long-arrow-right"> </span></a>
                        </div>
                    </div>
                </div>
				<?php
