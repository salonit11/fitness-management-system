...
?>
    ...
    <section class="events py-5">
        <div class="container py-md-5">
            <h3 class="title-w3pvt text-center">Dinner</h3>
            <?php
				$qry1="SELECT * FROM tbl_diet WHERE d_status='1' AND d_type='Dinner'";
            ...
            <div class="row mid-grids mt-5">
                <div class="col-md-5 content-w3pvt-img">
                    <a href="#"><img src="../admin/photos/<?php echo $result1['d_img']; ?>" alt="news image" class="img-fluid"></a>
                </div>
